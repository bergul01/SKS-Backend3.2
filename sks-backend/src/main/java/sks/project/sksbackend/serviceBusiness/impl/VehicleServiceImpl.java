...
public class VehicleServiceImpl implements VehicleService{
	...
	private VehicleRepository vehicleRepository;
	 ...
	 @Override
	    ...
	    @Override
	    public Vehicle getVehicleByTypeAndPlates(String vehicleType, String towPlate, String trailerPlate) {
	        return vehicleRepository.findByVehicleTypeAndTowPlateAndTrailerPlate(vehicleType, towPlate, trailerPlate);
	    }
